...
class Ellipse_Detector():
    ...
    def get_major_axis(self, ellipse,original_image,put_text=False):
        ...
        # 计算焊缝宽度
        dis = calib_obg.cal_distance((x1, y1), (x2, y2))
        if put_text:
            # 在图像右上角显示焊缝宽度
    ...
    def pre_centor(self):
        ...
        self.get_major_axis(ellipse2, img,True)
...
if __name__ == "__main__":
    ...
    # 读取标定板图像
    # 设置目录路径
    directory = r'D:\Work\THU\src\molten\1021-CCD-left\centor'  # 替换为您的文件夹路径

    calib_obg = Caliber(True)
    # calib_obg.read_img(r'.\1021-CCD-left\left-50du-ps.jpg')
    calib_obg.read_img(r'.\1021-CCD-left\centor-ps.jpg')
