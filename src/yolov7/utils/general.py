...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    # Settings
    min_wh, max_wh = 2, 2048  #4096 (pixels) minimum and maximum box width and height
    max_det = 30  #300 maximum number of detections per image
    max_nms = 3000  #3000 maximum number of boxes into torchvision.ops.nms()
